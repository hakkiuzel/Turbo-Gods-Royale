...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class Damageable : MonoBehaviour
    {
        ...
        public virtual void OnCollision(Collision collision)
        {
            ...
            {
                Damage(collision.relativeVelocity.magnitude * collisionRelativeVelocityToDamageFactor, collision.contacts[i].point, null, null);
            }          
        }
        ...
        public void Restore(bool reset = true)
        {
            ...
            if (name == "OrbShield") Debug.Log(name + "  " + healthCapacity + "  " + startingHealth);
            // Call the event
            onRestored.Invoke();
