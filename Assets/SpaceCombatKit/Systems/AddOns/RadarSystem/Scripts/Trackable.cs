...
{
    /// <summary>
    /// Unity event for running functions when a trackable is selected
    /// </summary>
    [System.Serializable]
    public class OnTrackableSelectedEventHandler : UnityEvent { }

    /// <summary>
    /// Unity event for running functions when a trackable is unselected
    /// </summary>
    [System.Serializable]
    public class OnTrackableUnselectedEventHandler : UnityEvent { }
    ...
    public class Trackable : MonoBehaviour
    {
        ...
        public OnTrackableSelectedEventHandler onSelected;

        // Called when this trackable is unselected by a target selector
        public OnTrackableUnselectedEventHandler onUnselected;
