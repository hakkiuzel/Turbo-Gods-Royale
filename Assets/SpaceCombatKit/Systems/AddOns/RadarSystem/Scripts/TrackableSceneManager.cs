...
{
    /// <summary>
    /// Unity event for running functions when a trackable is registered in the scene.
    /// </summary>
    [System.Serializable]
    public class OnTrackableRegisteredEventHandler : UnityEvent<Trackable> { }

    /// <summary>
    /// Unity event for running functions when a trackable is unregistered in the scene.
    /// </summary>
    [System.Serializable]
    public class OnTrackableUnregisteredEventHandler : UnityEvent<Trackable> { }
    ...
    public class TrackableSceneManager : MonoBehaviour
    {
        ...
        public OnTrackableRegisteredEventHandler onTrackableRegistered;

        // Trackable unregistered event 
        public OnTrackableUnregisteredEventHandler onTrackableUnregistered;
