...
namespace VSX.UniversalVehicleCombat
{
...

    {
        ...
        [SerializeField]
        protected LoadoutStats loadoutStatsController;
        ...
        protected void InitializeMenu()
        {
            ...
            loadoutStatsController.UpdateMaxStats(itemManager.modulePrefabs);
        }
        ...
        public void SelectModuleMount(int moduleMountIndex)
        {
            ...
            int mountedIndex = -1;
            for (int i = 0; i < displayVehicles[selectedVehicleIndex].ModuleMounts[selectedModuleMountIndex].MountableModules.Count; ++i)
            {

                int index = itemManager.modulePrefabs.IndexOf(displayVehicles[selectedVehicleIndex].ModuleMounts[selectedModuleMountIndex].MountableModules[i].modulePrefab);
        ...
        public void SelectModule(int newModuleIndex)
        {
            ...
            for (int i = 0; i < displayVehicles[selectedVehicleIndex].ModuleMounts[selectedModuleMountIndex].MountableModules.Count; ++i)
            {
                ...
                if (displayVehicles[selectedVehicleIndex].ModuleMounts[selectedModuleMountIndex].MountableModules[i].modulePrefab ==
                    itemManager.modulePrefabs[newModuleIndex])
                {
                    ...
                    module = displayVehicles[selectedVehicleIndex].ModuleMounts[selectedModuleMountIndex].Module();
                }
            }
            
            // Show the module stats
            loadoutStatsController.ShowStats(module);
