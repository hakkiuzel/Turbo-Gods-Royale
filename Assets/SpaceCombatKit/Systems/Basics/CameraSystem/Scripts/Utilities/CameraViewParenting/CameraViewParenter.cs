...
{   
    public class CameraViewParenter : MonoBehaviour, ICameraEntityUser
    {
        ...
        protected virtual void Awake()
        {
            ...
            {
                if (cameraViewParentingItems[i].m_Transform == null)
                {
                    Debug.LogError("Please assign the Transform value for item " + i.ToString() + " of the Camera View Parenter component on the " + name + " game object.");
                }
            }
        }
